...
public class WebDriverBonusTask {
    ...
    public void YouTube() {
        ...
        WebElement videoDespicableMe = driver.findElement(By.xpath("//h3[@class='title-and-badge style-scope ytd-video-renderer']/a[@title='Despicable Me 2 | Minions Banana Song (2013) SNSD TTS']"));
        videoDespicableMe.click();

        WebElement pageText = driver.findElement(By.xpath("//a[@title='YouTube Home']"));
